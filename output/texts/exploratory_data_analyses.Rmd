---
title: "Exploratory data analyses and data preparation report - Knotweed Tarping Survey
  (Martin *et al.*, 2023)"
...
For the meaning of variables, the reader is referred to the **metadata** PDF located in the "*data*" folder of the project: https://github.com/mrelnoob/jk.fanf.tarping or to the **Table 1** of the manuscript.
\
\
